...
Del /q /f /s "C:\Users\%%m\AppData\Local\Google\Chrome\User Data\Default\Application Cache\*"
Del /q /f /s "C:\Users\%%m\AppData\Local\Microsoft\Terminal Server Client\Cache\*"
Rmdir /s /q "C:\Users\%%m\AppData\Local\Google\Chrome\User Data\Default\File System\*"
